...
import type { ScrollSyncSig } from "../../types/public-types";
import {
	type GanttProps,
	type Task,
	ViewModeEnum,
...
export const Gantt: React.FunctionComponent<GanttProps> = ({
	...
	const [syncScrollX_OLD, setSyncScrollX_OLD] = useState(0);
	const [syncScrollY_OLD, setSyncScrollY_OLD] = useState(0);

	const [ignoreScrollEvent, setIgnoreScrollEvent] = useState(false);

	const [keyDownScrollEvent, setKeyDownScrollEvent] = useState(false);

	const [ignoreSyncScrollXEvent, setIgnoreSyncScrollXEvent] = useState(false);
	const [ignoreSyncScrollYEvent, setIgnoreSyncScrollYEvent] = useState(false);
